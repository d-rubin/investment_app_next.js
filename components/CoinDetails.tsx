...
import back from "next-crypto/img/back.png";
...
function CoinDetails() {
  ...
  const fetchChartData = async () => {
    ...
    switch (interval) {
      case "daily":
        url = `https://api.coingecko.com/api/v3/coins/${coin}/market_chart?vs_currency=eur&days=${days}&interval=daily`;
        break;
      default:
  ...
  const fetchMarketData = async () => {
    const url = `https://api.coingecko.com/api/v3/coins/${coin}?localization=false&tickers=true&market_data=true&community_data=false&developer_data=false&sparkline=false`;
